    ...
    .then(result => {
        ...
        for (i=0; i < result.data.length; i++){
            ...
            UserCard.innerHTML += `
              <div
                class="relative bg-neutral-primary-soft max-w-xs w-full p-6 border border-default rounded-base shadow-xs bg-blue-800"
                >
                <button
                    id="dropdownButton"
                ...
                <div class="flex flex-col items-center">
                    ...
                    />
                    <h5
                    class="mb-0.5 text-xl font-semibold tracking-tight text-heading"
                    >
                    ${result.data[i].name} (${result.data[i].username})
                    </h5>
                    <span class="text-sm text-body">${result.data[i].email}</span>
                    <span class="text-sm text-body">${result.data[i].website}</span>
                    <span class="text-sm text-body">${result.data[i].phone}</span>
                    <div class="flex mt-4 md:mt-6 gap-4">
                    <a
                        href="${result.data[i].website}"
